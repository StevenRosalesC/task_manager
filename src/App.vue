        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Sistema Personal</span>
                </a>
                <button type="button"
                    @click="showNavbar = !showNavbar"
                    class="inline-flex z-10 items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                ...
                <div class="w-full md:block md:w-auto z-10 absolute md:relative md:mt-0 mt-28" id="navbar-multi-level"
                    :class="{'hidden': !showNavbar, 'block': showNavbar}"
                >
                    <ul v-for="(module, index) in modules" :key="index"
                        class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <button  @click="goTo(module.path)"
                                class="block w-full text-left py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent"
                                aria-current="page">{{ module.name }}</button>
                        </li>
                        <!-- <li>
